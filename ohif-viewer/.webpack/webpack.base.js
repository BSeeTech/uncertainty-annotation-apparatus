...
module.exports = (env, argv, { SRC_DIR, ENTRY }) => {
  ...
  const config = {
    ...
    context: SRC_DIR,
    ignoreWarnings: [
      /export 'default'.*was not found in '@kitware\/vtk\.js/,
      /InjectManifest has been called multiple times/,
    ],
    stats: {
      colors: true,
      hash: true,
      ...
      rules: [
        {
          ...
          exclude: [/jpeg-lossless-decoder-js/, /[\\/]node_modules[\\/]@kitware[\\/]/, /[\\/]node_modules[\\/]@cornerstonejs[\\/]/],
        },
    ...
    resolve: {
      ...
      alias: {
        ...
        '@cornerstonejs/dicom-image-loader':
          '@cornerstonejs/dicom-image-loader',
		'@ohif/extension-collaboration': 'C:\\medical-imaging-platform\\ohif-viewer\\extensions\\collaboration\\src',
        '@thesis/extension-uncertainty': path.resolve(
          __dirname,
          '../extensions/extension-uncertainty/src'
        ),
        '@thesis/mode-uncertainty-review': path.resolve(
          __dirname,
          '../modes/uncertainty-review/src'
        ),
      },
