  ...
  findMatchByStudy(study, options) {
    ...
    this.protocols.forEach(protocol => {
      ...
      if (!rules || !rules.length) {
        // No top-level protocolMatchingRules — this is intentional for presets
        // (manually selected layouts), mode-specific protocols, and the default
        // fallback protocol.  The engine handles this by returning score 0.
        return;
      }
