...
// Singleton to prevent workbox InjectManifest from being called multiple times
...
module.exports = (env, argv) => {
  ...
  const mergedConfig = merge(baseConfig, {
    ...
    resolve: {
      modules: [
        ...
        path.resolve(
          __dirname,
          'C:/medical-imaging-platform/ohif-viewer/extensions/extension-uncertainty/node_modules'
        ),
        path.resolve(
          __dirname,
          'C:/medical-imaging-platform/ohif-viewer/modes/uncertainty-review/node_modules'
        ),
      ],
    },
    plugins: [
  ...
  const thesisPackageSources = [
    path.resolve(__dirname, '../../../extensions/extension-uncertainty/src'),
    path.resolve(__dirname, '../../../modes/uncertainty-review/src'),
    path.resolve(__dirname, '../../../node_modules/@thesis/extension-uncertainty/src'),
    path.resolve(__dirname, '../../../node_modules/@thesis/mode-uncertainty-review/src'),
  ];
