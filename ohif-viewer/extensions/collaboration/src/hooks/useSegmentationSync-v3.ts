            ...
            if (segmentationVolume?.scalarData) {
              ...
              if (finalSegVolume?.scalarData) {
                ...
                if (dims && dims.length === 3) {
                  console.log('[SegmentationSync] Applying Y+X flip transformation (vertical + horizontal)');
                ...
                console.log('[SegmentationSync] Copied labelmap data AFTER registration (with Y+X flip), length:', copyLength);
