    ...
    loadSegmentationsForViewport: async ({ segmentations, viewportId }) => {
      updateViewportsForSegmentationRendering({
        ...
        loadFn: async () => {
          ...
          // Fix: Ensure we have a valid ID. MonaiLabelPanel sends segmentationId, core expects id.
          const segmentationId = segmentation.id || segmentation.segmentationId;
          
          // Ensure the object passed to addOrUpdateSegmentation has the id property set
          if (!segmentation.id) {
